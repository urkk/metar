...
// Possible combinations of codes and modifiers. Not all codes can be combined. So the VC can only be applied to SH, TS, FG, VA, BLDU, BLSA, BLSN, PO, FC, SS, DS. It's impossible to have a "light" tornado (-FC), ground only fog (MIFG), etc. See documentation.
